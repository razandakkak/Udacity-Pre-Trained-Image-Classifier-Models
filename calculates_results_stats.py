...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        if results_dic[key][3] == 1:
            ...
            # Classifier classifies image as NOT a Dog (& pet image is NOT a dog)
            # counts number of correct non-dog classifications.
            if results_dic[key][4] == 0:
                results_stats_dic['n_correct_notdogs'] += 1

    # Calculate percentages based on the counts in results_stats_dic
